      ...
      <div className="max-w-md ">
        ...
        <div className="flex flex-col font-bold text-4xl my-2">
          ...
          <span className="text-gray-400 text-base my-3">
            ...
            <a className="text-slate-200" href="mailto:contato@designgroup.com">
        ...
        <div className="flex justify-end">
          <button
            ...
            className="mt-5 text-lg bg-blue-700 py-2 px-10 rounded-md hover:bg-blue-800 transition-all duration-200 font-bold"
          >
            Enviar
          </button>
        </div>
